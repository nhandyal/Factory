...
public class ImageArray{
	...
	public ImageArray(){
		...
		images.add(new ImageIcon("robot.png"));		// index 11		Kit/Part Picking
        ...
        images.add(new ImageIcon("gripper.png"));     // index 16     Gripper
        images.add(new ImageIcon("imageChart.png"));  // index 17     Image Chart
        images.add(new ImageIcon("gantry.png"));		// index 18		Gantry
	}
